    ...
    <div className="rounded-3xl p-8 shadow-sm bg-white/5 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <input
            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-base transition-all text-white"
            type="text"
            value={displayName}
        ...
        <div className="md:col-span-2 space-y-2">
          ...
          <textarea
            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-base transition-all text-white resize-none"
            rows={3}
            value={bio}
